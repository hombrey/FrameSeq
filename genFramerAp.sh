...
echo " <iframe class=\"subframe\" id=\"myIframe\" src=\"../../app/HTML/startpage/index.html\"></iframe>" >> 0_FrameX.html
echo "" >> 0_FrameX.html
...
echo "        <option value=\"../../app/HTML/startpage/index.html\">startPage</option> " >> 0_FrameX.html
echo "" >> 0_FrameX.html
